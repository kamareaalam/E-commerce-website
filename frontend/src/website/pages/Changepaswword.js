...
const ChangePassword = () => {
    ...
    const userJson = localStorage.getItem("webuser");
    ...
    const updatePassword = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:4000/api/website/weblogin/update/${userId}`, {
                method: "PUT",
